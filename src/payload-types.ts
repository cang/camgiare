...
export interface Service {
  ...
  title: string;
  /**
   * Hiển thị ở trang danh sách dịch vụ và dùng làm mô tả SEO mặc định.
   */
  ...
  pricing: {
    ...
    price?: number | null;
    /**
     * Ví dụ: /camera, /m2, /lần khảo sát
     */
    unit?: string | null;
  };
  serviceType: 'installation' | 'maintenance' | 'survey' | 'repair' | 'consulting' | 'other';
  /**
   * Khu vực phục vụ, ví dụ: TP.HCM, Hà Nội, Bình Dương
   */
  serviceAreas?:
    | {
        area: string;
...
export interface CarouselBlock {
  ...
  selectedDocs?:
    ...
    | null;
  /**
   * Trường này được tự động điền sau khi đọc dữ liệu
   */
  populatedDocs?:
    | {
        relationTo: 'products';
