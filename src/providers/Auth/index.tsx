...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // dùng để theo dõi một sự kiện đăng nhập hoặc đăng xuất duy nhất
  // hữu ích cho các hook `useEffect` chỉ nên chạy một lần
    ...
    const fetchMe = async () => {
      try {
        ...
        if (res.ok) {
          ...
          throw new Error('Đã xảy ra lỗi khi tải thông tin tài khoản của bạn.')
        }
      } catch (e) {
        setUser(null)
        throw new Error('Đã xảy ra lỗi khi tải thông tin tài khoản của bạn.')
