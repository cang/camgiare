    ...
    <Sheet onOpenChange={setIsOpen} open={isOpen}>
      ...
      <SheetContent side="left" className="px-4">
        <SheetHeader className="px-0 pt-4 pb-0">
          <SheetTitle>Cửa hàng của tôi</SheetTitle>
        ...
        {user ? (
          <div className="mt-4">
            <h2 className="text-xl mb-4">Tài khoản của tôi</h2>
            <hr className="my-2" />
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center">
              ...
              <span className="text-center text-sm text-muted-foreground sm:text-base">hoặc</span>
