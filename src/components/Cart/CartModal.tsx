...
export function CartModal() {
  ...
  useEffect(() => {
    // Đóng modal giỏ hàng khi đường dẫn (pathname) thay đổi.
    setIsOpen(false)
  }, [pathname])
    ...
    <Sheet onOpenChange={setIsOpen} open={isOpen}>
      ...
      <SheetContent className="flex flex-col">
        <SheetHeader>
          ...
          <SheetDescription>
            Quản lý giỏ hàng của bạn tại đây, thêm sản phẩm để xem tổng cộng.
          </SheetDescription>
        </SheetHeader>
        ...
        {!cart || cart?.items?.length === 0 ? (
          <div className="text-center flex flex-col items-center gap-2">
            ...
            <p className="text-center text-2xl font-bold">Giỏ hàng của bạn đang trống.</p>
          </div>
        ) : (
